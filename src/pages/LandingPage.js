...
const LandingPage = () => {
    ...
    return (
        <>
            <Seo
                title="BookCatalog - АБІС для бібліотек закладів освіти"
                description="Створюйте та керуйте своїм каталогом книг. Генеруйте акти списання та інвентарні книги. Посібник з користування розміщений у блозі."
                keywords="каталог книг, бібліотека, книги"
            />

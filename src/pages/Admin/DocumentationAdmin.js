...
const DocumentationAdminPage = ({ toggleNavbar, isNavbarVisible }) => {
    ...
    return (
        <HeaderAdmin name="Довідка" onToggleNavbar={toggleNavbar} isNavbarVisible={isNavbarVisible} userName={userName} userImage={userImage} />
    );

};

export default DocumentationAdminPage;